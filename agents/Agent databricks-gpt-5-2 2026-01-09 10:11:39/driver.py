...
# MAGIC
# MAGIC SYSTEM_PROMPT = """Você é uma analista de compras e responde perguntas sobre contratos. 
# MAGIC Não investe respostas se não encontrar nos documentos. 
# MAGIC Responda educadamente e com termos da área de contratos específicos. 
# MAGIC O texto sempre usa caracteres especiais. 
# MAGIC Responda sempre em português do brasil (pt-br) e de forma cordial e educada. 
# MAGIC Responda sempre com o texto em UTF-8."""
# MAGIC
# MAGIC
# MAGIC ###############################################################################
...
# MAGIC             index_name="fabio_goncalves.contract_agent.contracts_chunks_vs",
...
input_example = {
    "input": [
        {
            "role": "user",
            "content": "Qual é o volume mínimo mensal exigido para manter as condições?"
        }
    ],
    "custom_inputs": {
...
schema = "contract_agent"
model_name = "contract_agent_model"
...
agents.deploy(UC_MODEL_NAME, uc_registered_model_info.version, tags = {"endpointSource": "playground"},cale_to_zero=True)
